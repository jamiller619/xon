...
export const CATEGORY_DEFINITIONS: Record<MediaCategory, MediaCategoryInfo> = {
  ...
  [MediaCategory.TVShows]: {
    extensions: [".mp4", ".mkv", ".avi", ".mov", ".wmv", ".m4v", ".webm", ".mpg", ".mpeg", ".ogv"],
    mimeTypes: {
      ".mp4": "video/mp4",
      ".mkv": "video/x-matroska",
      ".avi": "video/x-msvideo",
  ...
  [MediaCategory.Music]: {
    extensions: [".mp3", ".flac", ".wav", ".aac", ".ogg", ".m4a", ".wma", ".opus", ".aiff", ".aif"],
    mimeTypes: {
      ".mp3": "audio/mpeg",
      ".flac": "audio/flac",
      ".wav": "audio/wav",
  ...
  [MediaCategory.Textures]: {
    extensions: [".png", ".jpg", ".jpeg", ".tga", ".dds", ".hdr", ".exr", ".bmp", ".tiff"],
    mimeTypes: {
      ".png": "image/png",
      ".jpg": "image/jpeg",
      ".jpeg": "image/jpeg",
  ...
  [MediaCategory.HomeVideos]: {
    extensions: [".mp4", ".mov", ".avi", ".wmv", ".3gp", ".mkv", ".m4v", ".webm"],
    mimeTypes: {
      ".mp4": "video/mp4",
      ".mov": "video/quicktime",
      ".avi": "video/x-msvideo",
 ...
 * When an extension is shared across categories, the first category in definition order wins.
 */
export const EXTENSION_TO_CATEGORY: Record<string, MediaCategory> = buildExtensionToCategory();
