...
describe("detectMultiDiscAlbums", () => {
  it("returns empty when all tracks are in the same directory", () => {
    const items: AnyItem[] = [
      makeItem({ id: "1", filePath: "/music/Album/01.mp3", metadata: '{"album":"Album"}' }),
      makeItem({ id: "2", filePath: "/music/Album/02.mp3", metadata: '{"album":"Album"}' }),
    ];
  ...
  it("detects multi-disc album when tracks are in disc subdirectories", () => {
    const items: AnyItem[] = [
      makeItem({ id: "1", filePath: "/music/Album/Disc 1/01.mp3", metadata: '{"album":"Album"}' }),
      makeItem({ id: "2", filePath: "/music/Album/Disc 1/02.mp3", metadata: '{"album":"Album"}' }),
      makeItem({ id: "3", filePath: "/music/Album/Disc 2/01.mp3", metadata: '{"album":"Album"}' }),
    ];
  ...
  it("uses parent directory name when album metadata is absent", () => {
    const items: AnyItem[] = [
      makeItem({ id: "1", filePath: "/music/MyAlbum/Disc 1/01.mp3", metadata: "{}" }),
      makeItem({ id: "2", filePath: "/music/MyAlbum/Disc 2/01.mp3", metadata: "{}" }),
    ];
    const result = detectMultiDiscAlbums(items);
    expect(result).toHaveLength(1);
