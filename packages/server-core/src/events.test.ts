...
describe("eventBus", () => {
  ...
  it("broadcasts scan:error event to listeners", () => {
    ...
    emitEvent({ type: "scan:error", payload: { libraryId: "lib-1", error: "Library not found" } });
  ...
  it("broadcasts media:removed event to listeners", () => {
    ...
    emitEvent({ type: "media:removed", payload: { libraryId: "lib-1", mediaItemId: "item-1" } });
  ...
  it("delivers events to multiple listeners", () => {
    ...
    emitEvent({ type: "scan:error", payload: { libraryId: "lib-1", error: "oops" } });
