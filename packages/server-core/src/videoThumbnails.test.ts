...
const { generateVideoThumbnails, isVideoCategory } = await import("./videoThumbnails.js");
...
describe("generateVideoThumbnails", () => {
  it("creates thumbnails directory and returns paths", async () => {
    ...
    const result = await generateVideoThumbnails("/media/movie.mp4", "item-123", "/data");
  ...
  it("uses timestamp 0 when duration cannot be determined", async () => {
    ...
    const result = await generateVideoThumbnails("/media/movie.mp4", "item-nodur", "/data");
  ...
  it("returns null when ffmpeg frame extraction fails", async () => {
    ...
    const result = await generateVideoThumbnails("/media/movie.mp4", "item-fail", "/data");
  ...
  it("returns null when ffmpeg process errors", async () => {
    ...
    const result = await generateVideoThumbnails("/media/movie.mp4", "item-err", "/data");
  ...
  it("returns null when sharp resize fails", async () => {
    ...
    const result = await generateVideoThumbnails("/media/movie.mp4", "item-sharpfail", "/data");
  ...
  it("uses mediaItemId in thumbnail filenames", async () => {
    ...
    const result = await generateVideoThumbnails("/media/video.mkv", "my-unique-id", "/mydata");
