  ...
  return (
    <div className={styles.page ?? ""}>
        ...
        <form onSubmit={saveProfile} className={styles.form ?? ""}>
          ...
          <div className={styles.fieldGroup ?? ""}>
            ...
            <input
              ...
              onChange={(e) => setProfile((p) => ({ ...p, avatarUrl: e.target.value || null }))}
            />
          </div>
      ...
      <section className={styles.section ?? ""}>
        ...
        <div className={styles.fieldGroup ?? ""}>
          ...
          <select
            ...
            onChange={(e) => setProfile((p) => ({ ...p, maxContentRating: e.target.value }))}
          >
        ...
        <label className={styles.prefOption ?? ""}>
          <input
            ...
            onChange={(e) => setProfile((p) => ({ ...p, hideDrmItems: e.target.checked }))}
          />
        ...
        <div className={styles.saveRow ?? ""}>
          <button
            ...
            onClick={saveProfile as unknown as React.MouseEventHandler<HTMLButtonElement>}
          >
      ...
      <section className={styles.section ?? ""}>
        ...
        <p className={styles.sectionDescription ?? ""}>Default layout for library browsing.</p>
        <div className={styles.viewOptions ?? ""}>
          <label className={styles.themeOption ?? ""}>
            ...
            <span className={styles.themeDescription ?? ""}>Show items as a grid of cards</span>
          </label>
          <label className={styles.themeOption ?? ""}>
            <input
              type="radio"
            ...
            <span className={styles.themeDescription ?? ""}>Show items in a compact list</span>
          </label>
        </div>
      </section>
