...
interface ScanStoreState {
  ...
  /**
   * Last scan-completion time per library this session. Unlike `scans`
   * entries, these survive the banner auto-dismiss — used to cache-bust
   * library thumbnails that were (re)generated by a scan.
   */
  completedAt: Record<string, number>
  applyStarted: (libraryId: string) => void
